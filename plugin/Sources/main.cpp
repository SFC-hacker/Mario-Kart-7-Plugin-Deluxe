...
namespace CTRPluginFramework
{
    ...
    int main(void)
    {
		PluginMenu *menu = new PluginMenu(Color::LimeGreen << "Mario Kart 7 Plugin Deluxe", 3, 0, 3, "- Plugin for Mario Kart 7 EUR/JPN/USA.\n- Made for games with 1.2 online update.");
		OSD::Notify("Dev", Color::Orange);
		...
		subfolder->Append(new MenuEntry("Always Have Star Power", alwaysStarPower, "This code allows you to get the Star power forever."));
		subfolder->Append(new MenuEntry("Blinking Invincibility", alwaysBlinking, "This code allows you to be invincible.\nThis effect is visible for online opponents only."));
		...
		subfolder->Append(new MenuEntry("Drive Out Of Bounds", driveBounds, "This code allows you to drive out of the boundaries." << Color::LimeGreen << "\nActivator:\n-Y = Enabled\n-Start = Disabled."));
		...
		subfolder->Append(new MenuEntry("Pop Items", popItems, "This code allows you to pop Green Sheel, Red Shell, Bob-Omb, Banana, on the ground." << Color::LimeGreen << "\nActivators:\n-Hold X + Press L = Pop Items"));
		...
		subfolder = new MenuFolder("" << Color::Yellow << "[ Item Limiters & Delimiters ]", "" << Color::LimeGreen << "Codes for item limits.");
		subfolder->Append(new MenuEntry("Extend Mushroom Limit", dropMushAmount, "This code allows you to drop more Mushrooms.\n\nEnable this code in a menu or restart the race to apply the change properly."));
		subfolder->Append(new MenuEntry("Extend Star Limit", dropStarAmount, "This code allows you to drop more Stars.\n\nEnable this code in a menu or restart the race to apply the change properly."));
		subfolder->Append(new MenuEntry("Bob-Omb Amount Modifier", bombAmount, "This code allows you to use more Bob-Ombs.\n\nEnable this code in a menu or restart the race to apply the change properly."));
		subfolder->Append(new MenuEntry("Fireball Amount Modifier", fireballAmount, "This code allows you to use more fireballs from the Fire Flower.\n\nEnable this code in a menu or restart the race to apply the change properly."));
		itemcodes->Append(subfolder);//6
		
		subfolder = new MenuFolder("" << Color::Yellow << "[ Item Speeds ]", "" << Color::LimeGreen << "Codes item speeds.");
		subfolder->Append(new MenuEntry("Bullet Speed Modifier", killerSpeed, "This code allows you to control the speed of the Bullet Bill." << Color::LimeGreen << "\nActivators:\n-X = Very Fast\n-B = Stopped\n-A = Normal Speed" << Color::Red << "\nThis code is restricted online!"));
		...
		racecodes->Append(new MenuEntry("No Disconnect", NoDC, "This code allows you to drive backward and stay stopped during online races without being disconnected." << Color::Red << "\nThis code is restricted online!"));
		...
		battlecodes->Append(new MenuEntry("Anti Blue Shell Crash", antiKouraB, "This code allows you to prevent the crash occuring when a Blue Shell goes out of the boundaries in battle mode." << Color::Red << "\nThis code is restricted online!"));
	...
	static void 	AntiItemDelimiters(void)
	{
		u64 titleID = Process::GetTitleID();
		u32 hook = *(u32 *)0x5EBF80;
