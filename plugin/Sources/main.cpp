...
namespace CTRPluginFramework
{
    ...
    int main(void)
    {
		PluginMenu *menu = new PluginMenu(Color::LimeGreen << "Mario Kart 7 Plugin Deluxe", 3, 0, 3, "- Public plugin for Mario Kart 7 EUR/JPN/USA.\n- Made for games with 1.2 online update.");
		OSD::Notify("ver: 3.0.3", Color::Yellow);
